...
public:
    // Expression builders
    static ExpressionPtr make_literal(LiteralExpression::Value value, SourceLocation location = {});
    ...
    static StatementPtr make_assignment(ExpressionList targets, ExpressionList values,
                                       SourceLocation location = {});
    static StatementPtr make_if(ExpressionPtr condition, StatementPtr then_body,
