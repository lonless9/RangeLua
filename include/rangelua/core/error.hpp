...
public:
    ...
    [[nodiscard]] const SourceLocation& source_location() const noexcept { return source_location_; }
...
constexpr auto and_then(const Result<T>& result, F&& func) -> decltype(func(std::declval<T>())) {
