...
Result<std::vector<Value>> VirtualMachine::call(const Value& function, const std::vector<Value>& args) {
...
Status VirtualMachine::setup_call_frame(const backend::BytecodeFunction& function, Size arg_count) {
...
Status VirtualMachine::op_sub(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_mul(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_div(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_mod(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_pow(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_unm(Register /* a */, Register /* b */) { return std::monostate{}; }
Status VirtualMachine::op_band(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_bor(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_bxor(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_shl(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_shr(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_bnot(Register /* a */, Register /* b */) { return std::monostate{}; }
Status VirtualMachine::op_eq(Register /* a */, Register /* b */, std::int16_t /* sbx */) { return std::monostate{}; }
Status VirtualMachine::op_lt(Register /* a */, Register /* b */, std::int16_t /* sbx */) { return std::monostate{}; }
Status VirtualMachine::op_le(Register /* a */, Register /* b */, std::int16_t /* sbx */) { return std::monostate{}; }
Status VirtualMachine::op_not(Register /* a */, Register /* b */) { return std::monostate{}; }
Status VirtualMachine::op_len(Register /* a */, Register /* b */) { return std::monostate{}; }
Status VirtualMachine::op_gettable(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_settable(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_newtable(Register /* a */) { return std::monostate{}; }
Status VirtualMachine::op_call(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_tailcall(Register /* a */, Register /* b */) { return std::monostate{}; }
Status VirtualMachine::op_test(Register /* a */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_testset(Register /* a */, Register /* b */, Register /* c */) { return std::monostate{}; }
Status VirtualMachine::op_getupval(Register /* a */, UpvalueIndex /* b */) { return std::monostate{}; }
Status VirtualMachine::op_setupval(Register /* a */, UpvalueIndex /* b */) { return std::monostate{}; }
Status VirtualMachine::op_getglobal(Register /* a */, std::uint16_t /* bx */) { return std::monostate{}; }
Status VirtualMachine::op_setglobal(Register /* a */, std::uint16_t /* bx */) { return std::monostate{}; }
