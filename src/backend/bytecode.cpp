...
StringView Disassembler::opcode_name(OpCode op) noexcept {
    switch (op) {
        ...
        case OpCode::OP_LOADI: return "LOADI";
        case OpCode::OP_LOADF: return "LOADF";
        case OpCode::OP_LOADK: return "LOADK";
        case OpCode::OP_LOADKX: return "LOADKX";
        ...
        case OpCode::OP_LEN: return "LEN";
        case OpCode::OP_GETTABLE: return "GETTABLE";
        case OpCode::OP_SETTABLE: return "SETTABLE";
        case OpCode::OP_NEWTABLE: return "NEWTABLE";
        case OpCode::OP_SELF: return "SELF";
        case OpCode::OP_CALL: return "CALL";
        case OpCode::OP_TAILCALL: return "TAILCALL";
...
Result<std::monostate> BytecodeValidator::validate_instruction(Instruction /* instr */, const BytecodeFunction& /* function */, Size /* index */) {
