...
Variant<Register, UpvalueIndex, std::monostate> ScopeManager::resolve_variable(const String& name) {
...
Register CodeGenerator::emit_binary_operation(frontend::BinaryOpExpression::Operator op, Register left, Register right) {
    // TODO: Implement binary operation emission
    return 0;
}

Register CodeGenerator::emit_unary_operation(frontend::UnaryOpExpression::Operator op, Register operand) {
